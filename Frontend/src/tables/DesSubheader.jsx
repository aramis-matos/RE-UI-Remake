...
import { desSubheader } from "./TableResources";

const DesSubheader = (props) => {
  ...
  const handleCheckAll = (checked) => {
    const relatedCheckboxes = document.getElementsByClassName("checkAllDes");
    if (checked) {
  ...
  const handleCheck = (checked, fieldName) => {
    if (!checked) {
      document.getElementById("checkAllDes").checked = false;
    }
  ...
  return (
    <div id="desPanel" className="field-panel" style = {(props.toShow[4] ||
      !(
        props.toShow[0] ||
        props.toShow[1] ||
        props.toShow[2] ||
      ...
      <div className="field-table" style = {(props.toShow[4] ||
        !(
          props.toShow[0] ||
          props.toShow[1] ||
          props.toShow[2] ||
...
DesSubheader.propTypes = {
  values: PropTypes.any,
  allowed: PropTypes.any,
  onChange: PropTypes.func,
};

export default DesSubheader;
