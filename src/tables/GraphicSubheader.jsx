...
import { graphicSubheader } from "./TableResources";

const GraphicSubheader = (props) => {
  ...
  const handleCheckAll = (checked) => {
    const relatedCheckboxes =
      document.getElementsByClassName("checkAllGraphic");
    if (checked) {
  ...
  return (
    <div id="graphicPanel" className="field-panel" style = {(props.toShow[2] ||
      !(
        props.toShow[0] ||
        props.toShow[1] ||
        props.toShow[2] ||
      ...
      <div className="field-table" style = {(props.toShow[2] ||
        !(
          props.toShow[0] ||
          props.toShow[1] ||
          props.toShow[2] ||
...
GraphicSubheader.propTypes = {
  values: PropTypes.any,
  allowed: PropTypes.any,
  onChange: PropTypes.func,
};

export default GraphicSubheader;
